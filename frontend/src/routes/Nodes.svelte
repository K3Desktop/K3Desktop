            ...
            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-750">
              ...
              <td class="px-4 py-3">
                ...
                {:else}
                  ...
                  {#if n.k8sReady !== null}
                    <span class="ml-1 px-2 py-0.5 rounded-full text-xs font-medium {n.k8sReady ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400'}">
                      {n.k8sReady ? 'Ready' : 'Not Ready'}
                    </span>
                  {/if}
                {/if}
              </td>
